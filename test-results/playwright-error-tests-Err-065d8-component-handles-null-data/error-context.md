...
- Name: playwright-error-tests.spec.ts >> Error Handling - Network Disconnect Simulation >> DailyQuote component handles null data
- Location: playwright-error-tests.spec.ts:108:7
...
Call log:
  ...
  - waiting for locator('#daily-quote')
