...
- Name: playwright-error-tests.spec.ts >> Error Handling - Network Disconnect Simulation >> ErrorBoundary catches render errors gracefully
- Location: playwright-error-tests.spec.ts:21:7
