...
- Name: playwright-error-tests.spec.ts >> Error Handling - Network Disconnect Simulation >> Touch targets meet WCAG AA (min 56px) - Retry button
- Location: playwright-error-tests.spec.ts:140:7
