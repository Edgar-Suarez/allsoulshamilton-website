...
- Name: playwright-error-tests.spec.ts >> Error Handling - Network Disconnect Simulation >> Announcements component handles empty array
- Location: playwright-error-tests.spec.ts:124:7
...
Call log:
  ...
  - waiting for locator('#announcements')
